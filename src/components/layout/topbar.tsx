  ...
  return (
    <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b border-border bg-background px-6">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="text-right leading-tight"><div className="text-[13px] font-medium">{perfil.full_name}</div><div className="text-[11px] text-muted-foreground">{ROLE_LABEL[perfil.role]}</div></div>
